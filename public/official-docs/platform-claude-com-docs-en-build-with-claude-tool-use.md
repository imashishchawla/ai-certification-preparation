---
title: "Platform Claude Com Docs En Build With Claude Tool Use"
meta: "Official Anthropic docs"
tags: ["study", "official-docs"]
---

<!-- source: https://platform.claude.com/docs/en/build-with-claude/tool-use (fetched https://docs.anthropic.com/en/build-with-claude/tool-use.md) -->
