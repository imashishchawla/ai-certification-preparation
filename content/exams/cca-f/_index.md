...
<div class="card-grid">
  <a href="/exams/cca-f/study-guides/" class="card">
  ...
  <a href="/exams/cca-f/exam-notes/" class="card">
    <span class="tag">NOTES & HACKS</span>
    <h3>Exam Notes</h3>
    <p>Notes about exams, structure, questions, and quick hacks to solve exam patterns and task statements efficiently.</p>
  </a>

  <a href="/exams/cca-f/articles/" class="card">
    <span class="tag">ARTICLES & BLOGS</span>
    <h3>Technical Articles</h3>
    <p>Includes external articles and blogs downloaded to show exam structure, cost breakdown, and useful community guides.</p>
  </a>

  <a href="/exams/cca-f/study-materials/" class="card">
    <span class="tag">PDFs & DOCS</span>
    <h3>Official Documents & PDFs</h3>
    <p>Includes list of all official exam guide PDFs, scraped engineering docs, and reference specification files.</p>
  </a>

  <a href="/exams/cca-f/resources/" class="card">
    <span class="tag">RESOURCES & FLASHCARDS</span>
    <h3>Resources & Anti-Patterns</h3>
    <p>Flashcards, canonical wrong-answer anti-patterns, domain glossary, and scenario walkthroughs.</p>
  </a>
</div>
...
<div class="card-grid">
  <a href="/exams/cca-f/sample-questions/" class="card" style="border-left: 6px solid var(--accent);">
  ...
  <a href="/exams/cca-f/mock-test/" class="card" style="border-left: 6px solid var(--focus-ring);">
