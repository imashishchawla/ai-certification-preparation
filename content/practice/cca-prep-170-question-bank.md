---
title: "cca-prep — 170 Questions"
count: "170 Q"
meta: "4 difficulty tiers · why-wrong explanations · doc links"
tags: ["practice", "questions"]
---
# CCA-Prep Question Bank (170 scenario questions)

Source: github.com/vinipx/cca-prep · src/data/questions.ts

Legend: tier = basic / intermediate / advanced / exam · ✔ marks the correct option


## Q1 · D1 Agentic Architecture & Orchestration · [basic]
...
## Q2 · D1 Agentic Architecture & Orchestration · [basic]
...
## Q3 · D1 Agentic Architecture & Orchestration · [basic]
...
## Q4 · D1 Agentic Architecture & Orchestration · [basic]
...
## Q5 · D1 Agentic Architecture & Orchestration · [basic]
...
## Q6 · D1 Agentic Architecture & Orchestration · [intermediate]
...
## Q7 · D1 Agentic Architecture & Orchestration · [intermediate]
...
## Q8 · D1 Agentic Architecture & Orchestration · [intermediate]
...
## Q9 · D1 Agentic Architecture & Orchestration · [intermediate]
...
## Q10 · D1 Agentic Architecture & Orchestration · [intermediate]
...
## Q11 · D1 Agentic Architecture & Orchestration · [intermediate]
...
Refs: [Agent SDK — hooks documentation](https://github.com/anthropics/claude-agent-sdk-python)

## Q12 · D1 Agentic Architecture & Orchestration · [intermediate]
...
Refs: [Claude Code — memory and sessions](https://code.claude.com/docs/en/memory)

## Q13 · D1 Agentic Architecture & Orchestration · [intermediate]
...
Refs: [Claude Code — sessions and forking](https://code.claude.com/docs/en/overview)

## Q14 · D1 Agentic Architecture & Orchestration · [advanced]
...
## Q15 · D1 Agentic Architecture & Orchestration · [advanced]
...
## Q16 · D1 Agentic Architecture & Orchestration · [advanced]
...
## Q17 · D1 Agentic Architecture & Orchestration · [advanced]

When should you start a new session with an injected structured summary rather than resuming a prior session with `--resume`?
...
> Resume (`--resume`) is effective when prior context is mostly still valid. When significant state changes have occurred (large refactors, database schema changes, dependency updates), the prior tool results become stale and can mislead Claude into reasoning from outdated assumptions. A fresh session with an injected structured summary of current state is more reliable in these cases.

Refs: [Claude Code — memory and sessions](https://code.claude.com/docs/en/memory)

## Q18 · D1 Agentic Architecture & Orchestration · [advanced]
...
Refs: [Agent SDK — hooks](https://github.com/anthropics/claude-agent-sdk-python) · [Building agents with the Claude Agent SDK](https://www.anthropic.com/engineering/building-agents-with-the-claude-agent-sdk)

## Q19 · D1 Agentic Architecture & Orchestration · [advanced]
...
## Q20 · D1 Agentic Architecture & Orchestration · [advanced]
...
## Q21 · D1 Agentic Architecture & Orchestration · [advanced]
...
## Q22 · D1 Agentic Architecture & Orchestration · [exam]
...
Refs: [Building agents with the Claude Agent SDK](https://www.anthropic.com/engineering/building-agents-with-the-claude-agent-sdk) · [Agent SDK — hooks](https://github.com/anthropics/claude-agent-sdk-python)

## Q23 · D1 Agentic Architecture & Orchestration · [exam]
...
## Q24 · D1 Agentic Architecture & Orchestration · [exam]
...
## Q25 · D1 Agentic Architecture & Orchestration · [exam]
*Scenario: Multi-Agent Research System*
...
## Q26 · D1 Agentic Architecture & Orchestration · [exam]
*Scenario: Customer Support Resolution Agent*
...
## Q27 · D1 Agentic Architecture & Orchestration · [exam]
*Scenario: Customer Support Resolution Agent*
...
## Q28 · D2 Tool Design & MCP Integration · [basic]
...
## Q29 · D2 Tool Design & MCP Integration · [basic]
...
Refs: [MCP documentation](https://modelcontextprotocol.io/docs)

## Q30 · D2 Tool Design & MCP Integration · [basic]
...
## Q31 · D2 Tool Design & MCP Integration · [basic]
...
## Q32 · D2 Tool Design & MCP Integration · [intermediate]
...
## Q33 · D2 Tool Design & MCP Integration · [intermediate]
...
## Q34 · D2 Tool Design & MCP Integration · [intermediate]
...
Refs: [Tool use overview](https://platform.claude.com/docs/en/agents-and-tools/tool-use/overview) · [Building agents with the Claude Agent SDK](https://www.anthropic.com/engineering/building-agents-with-the-claude-agent-sdk)

## Q35 · D2 Tool Design & MCP Integration · [intermediate]
...
## Q36 · D2 Tool Design & MCP Integration · [intermediate]

Your system prompt contains the phrase "analyze content from URLs." You have a tool named `analyze_content`. What unintended consequence might occur?

  **(A)** The system prompt phrase will completely override the tool description text
✔ **(B)** The phrase "analyze content" will cause Claude to over-invoke that tool name
  **(C)** No consequence — system prompts and tool descriptions are processed separately
  **(D)** Claude will create a new virtual tool called "analyze content from URLs"

**Correct: B**

> System prompt wording is keyword-sensitive and can create unintended tool associations. The phrase "analyze content" in a system prompt can cause Claude to over-invoke `analyze_content` in contexts where it is not appropriate. Always review system prompts for phrases that might conflict with or trigger tool name associations unexpectedly.

Refs: [Tool use overview](https://platform.claude.com/docs/en/agents-and-tools/tool-use/overview)

## Q37 · D2 Tool Design & MCP Integration · [advanced]
...
## Q38 · D2 Tool Design & MCP Integration · [advanced]
...
## Q39 · D2 Tool Design & MCP Integration · [advanced]
...
## Q40 · D2 Tool Design & MCP Integration · [advanced]
...
## Q41 · D2 Tool Design & MCP Integration · [advanced]
...
Refs: [Agent SDK — permissions](https://platform.claude.com/docs/en/agent-sdk/agent-loop)

## Q42 · D2 Tool Design & MCP Integration · [exam]
*Scenario: Customer Support Resolution Agent*
...
## Q43 · D2 Tool Design & MCP Integration · [exam]
...
## Q44 · D2 Tool Design & MCP Integration · [exam]
*Scenario: Developer Productivity Tools*
...
Refs: [Agent SDK — permissions](https://platform.claude.com/docs/en/agent-sdk/agent-loop) · [Tool use overview](https://platform.claude.com/docs/en/agents-and-tools/tool-use/overview)

## Q45 · D3 Claude Code Configuration & Workflows · [basic]
...
## Q46 · D3 Claude Code Configuration & Workflows · [basic]
...
## Q47 · D3 Claude Code Configuration & Workflows · [basic]
...
## Q48 · D3 Claude Code Configuration & Workflows · [basic]
...
## Q49 · D3 Claude Code Configuration & Workflows · [intermediate]
...
## Q50 · D3 Claude Code Configuration & Workflows · [intermediate]

You want to package a multi-step code review workflow (run linting, check coverage, review security, summarize findings) that your team can invoke with a single command. What Claude Code feature enables this?

  **(A)** A CLAUDE.md entry that lists all review steps as numbered instructions
  **(B)** A Bash alias that chains multiple separate claude commands together in a shell script
  **(C)** An Agent Skill defined in a dedicated `SKILL.md` file in the project
✔ **(D)** A custom slash command like `/review-pr` that packages the full workflow

**Correct: D**

> Custom slash commands package repeatable, multi-step workflows into a single invocable command. `/review-pr` can encode: lint → check test coverage → security scan → summarize findings. Team members invoke it without needing to know the underlying steps. This is distinct from Agent Skills (which extend Claude's knowledge/behavior) and CLAUDE.md (which provides persistent context).

Refs: [Claude Code overview](https://code.claude.com/docs/en/overview)

## Q51 · D3 Claude Code Configuration & Workflows · [intermediate]
...
## Q52 · D3 Claude Code Configuration & Workflows · [intermediate]
...
## Q53 · D3 Claude Code Configuration & Workflows · [intermediate]
...
## Q54 · D3 Claude Code Configuration & Workflows · [intermediate]
...
## Q55 · D3 Claude Code Configuration & Workflows · [advanced]
...
## Q56 · D3 Claude Code Configuration & Workflows · [advanced]
...
Refs: [Claude Code settings configuration](https://code.claude.com/docs/en/overview)

## Q57 · D3 Claude Code Configuration & Workflows · [advanced]
...
Refs: [Claude Code overview — Agent Skills](https://code.claude.com/docs/en/overview)

## Q58 · D3 Claude Code Configuration & Workflows · [exam]
...
## Q59 · D3 Claude Code Configuration & Workflows · [exam]
...
Refs: [Claude Code overview — plan mode](https://code.claude.com/docs/en/overview)

## Q60 · D3 Claude Code Configuration & Workflows · [exam]
*Scenario: Claude Code for CI/CD*
...
Refs: [Agent SDK — permissions](https://platform.claude.com/docs/en/agent-sdk/agent-loop) · [Claude Code settings](https://code.claude.com/docs/en/overview)

## Q61 · D4 Prompt Engineering & Structured Output · [basic]
...
## Q62 · D4 Prompt Engineering & Structured Output · [basic]
...
## Q63 · D4 Prompt Engineering & Structured Output · [basic]
...
Refs: [Message Batches API](https://platform.claude.com/docs/en/build-with-claude/batch-processing)

## Q64 · D4 Prompt Engineering & Structured Output · [basic]
...
## Q65 · D4 Prompt Engineering & Structured Output · [intermediate]

You need to extract structured data from 50,000 product descriptions overnight. The downstream system ingests a batch file at 6 AM the next day. Assume the batch job is submitted with sufficient lead time for completion. Which API approach is most appropriate?
...
## Q66 · D4 Prompt Engineering & Structured Output · [intermediate]
...
## Q67 · D4 Prompt Engineering & Structured Output · [intermediate]
...
## Q68 · D4 Prompt Engineering & Structured Output · [intermediate]

You are building a document review system with a few iterations: first iteration extracts all claims, second iteration verifies each claim against sources, third iteration generates a credibility report. What architectural pattern does this represent?
...
## Q69 · D4 Prompt Engineering & Structured Output · [intermediate]
...
## Q70 · D4 Prompt Engineering & Structured Output · [intermediate]
...
Refs: [Tool use — structured outputs mode](https://platform.claude.com/docs/en/agents-and-tools/tool-use/overview)

## Q71 · D4 Prompt Engineering & Structured Output · [advanced]
...
## Q72 · D4 Prompt Engineering & Structured Output · [advanced]
...
## Q73 · D4 Prompt Engineering & Structured Output · [advanced]
...
## Q74 · D4 Prompt Engineering & Structured Output · [advanced]
...
Refs: [Message Batches API](https://platform.claude.com/docs/en/build-with-claude/batch-processing) · [Structured outputs](https://platform.claude.com/docs/en/build-with-claude/structured-outputs)

## Q75 · D4 Prompt Engineering & Structured Output · [exam]
*Scenario: Structured Data Extraction*
...
## Q76 · D4 Prompt Engineering & Structured Output · [exam]
*Scenario: Claude Code for CI/CD*
...
## Q77 · D4 Prompt Engineering & Structured Output · [exam]
*Scenario: Structured Data Extraction*
...
Refs: [Structured outputs](https://platform.claude.com/docs/en/build-with-claude/structured-outputs) · [Prompt engineering overview](https://platform.claude.com/docs/en/build-with-claude/prompt-engineering/overview)

## Q78 · D4 Prompt Engineering & Structured Output · [exam]
*Scenario: Structured Data Extraction*
...
## Q79 · D5 Context Management & Reliability · [basic]
...
## Q80 · D5 Context Management & Reliability · [basic]
...
## Q81 · D5 Context Management & Reliability · [basic]
...
## Q82 · D5 Context Management & Reliability · [intermediate]
...
## Q83 · D5 Context Management & Reliability · [intermediate]
...
## Q84 · D5 Context Management & Reliability · [intermediate]
...
Refs: [Claude Code — memory and context](https://code.claude.com/docs/en/memory)

## Q85 · D5 Context Management & Reliability · [intermediate]
...
## Q86 · D5 Context Management & Reliability · [advanced]
...
## Q87 · D5 Context Management & Reliability · [advanced]
...
## Q88 · D5 Context Management & Reliability · [advanced]
...
## Q89 · D5 Context Management & Reliability · [advanced]
...
## Q90 · D5 Context Management & Reliability · [exam]
*Scenario: Customer Support Resolution Agent*
...
## Q91 · D5 Context Management & Reliability · [exam]
*Scenario: Multi-Agent Research System*
...
## Q92 · D5 Context Management & Reliability · [exam]
*Scenario: Structured Data Extraction*
...
## Q93 · D5 Context Management & Reliability · [exam]
*Scenario: Code Generation with Claude Code*
...
## Q94 · D1 Agentic Architecture & Orchestration · [advanced]
...
## Q95 · D3 Claude Code Configuration & Workflows · [advanced]
...
Refs: [Claude Code settings](https://code.claude.com/docs/en/overview)

## Q96 · D2 Tool Design & MCP Integration · [exam]
*Scenario: Customer Support Resolution Agent*
...
## Q97 · D4 Prompt Engineering & Structured Output · [exam]
*Scenario: Structured Data Extraction*
...
Refs: [Tool use — structured outputs mode](https://platform.claude.com/docs/en/agents-and-tools/tool-use/overview) · [Structured outputs](https://platform.claude.com/docs/en/build-with-claude/structured-outputs)

## Q98 · D5 Context Management & Reliability · [exam]
*Scenario: Code Generation with Claude Code*
...
## Q99 · D1 Agentic Architecture & Orchestration · [exam]
*Scenario: Multi-Agent Research System*
...
## Q100 · D2 Tool Design & MCP Integration · [advanced]
...
## Q101 · D1 Agentic Architecture & Orchestration · [exam]
...
## Q102 · D2 Tool Design & MCP Integration · [exam]
*Scenario: You are building a customer support resolution agent using the Claude Agent SDK. The agent handles high-ambiguity requests like returns, billing disputes, and account issues. It has access to your backend systems through custom MCP tools (get_customer, lookup_order, process_refund, escalate_to_human). Your target is 80%+ first-contact resolution while knowing when to escalate.*
...
## Q103 · D5 Context Management & Reliability · [exam]
*Scenario: You are building a customer support resolution agent using the Claude Agent SDK. The agent handles high-ambiguity requests like returns, billing disputes, and account issues. It has access to your backend systems through custom MCP tools (get_customer, lookup_order, process_refund, escalate_to_human). Your target is 80%+ first-contact resolution while knowing when to escalate.*
...
Refs: [Human-in-the-loop patterns](https://docs.anthropic.com/en/docs/build-with-claude/agentic-systems/human-in-the-loop)

## Q104 · D3 Claude Code Configuration & Workflows · [exam]
...
## Q105 · D3 Claude Code Configuration & Workflows · [exam]
*Scenario: You are using Claude Code to accelerate software development. Your team uses it for code generation, refactoring, debugging, and documentation. You need to integrate it into your development workflow with custom slash commands, CLAUDE.md configurations, and understand when to use plan mode vs direct execution.*
...
## Q106 · D3 Claude Code Configuration & Workflows · [exam]
*Scenario: You are using Claude Code to accelerate software development. Your team uses it for code generation, refactoring, debugging, and documentation. You need to integrate it into your development workflow with custom slash commands, CLAUDE.md configurations, and understand when to use plan mode vs direct execution.*
...
## Q107 · D1 Agentic Architecture & Orchestration · [exam]
...
## Q108 · D5 Context Management & Reliability · [exam]
*Scenario: You are building a multi-agent research system using the Claude Agent SDK. A coordinator agent delegates to specialized subagents: one searches the web, one analyzes documents, one synthesizes findings, and one generates reports. The system researches topics and produces comprehensive, cited reports.*
...
## Q109 · D2 Tool Design & MCP Integration · [exam]
*Scenario: You are building a multi-agent research system using the Claude Agent SDK. A coordinator agent delegates to specialized subagents: one searches the web, one analyzes documents, one synthesizes findings, and one generates reports. The system researches topics and produces comprehensive, cited reports.*
...
## Q110 · D3 Claude Code Configuration & Workflows · [exam]
...
Refs: [Claude Code CLI reference](https://docs.anthropic.com/en/docs/claude-code/cli-reference)

## Q111 · D4 Prompt Engineering & Structured Output · [exam]
*Scenario: You are integrating Claude Code into your CI/CD pipeline. The system runs automated code reviews, generates test cases, and provides feedback on pull requests. You need to design prompts that provide actionable feedback and minimize false positives.*
...
Refs: [Message Batches API](https://docs.anthropic.com/en/docs/build-with-claude/batch-processing)

## Q112 · D4 Prompt Engineering & Structured Output · [exam]
*Scenario: You are integrating Claude Code into your CI/CD pipeline. The system runs automated code reviews, generates test cases, and provides feedback on pull requests. You need to design prompts that provide actionable feedback and minimize false positives.*
...
Refs: [Multi-pass review architecture](https://docs.anthropic.com/en/docs/build-with-claude/agentic-systems/orchestration)

## Q113 · D1 Agentic Architecture & Orchestration · [intermediate]
...
## Q114 · D1 Agentic Architecture & Orchestration · [advanced]
...
Refs: [Parallel subagent execution](https://platform.claude.com/docs/en/agent-sdk/tasks)

## Q115 · D1 Agentic Architecture & Orchestration · [intermediate]

Your agent integrates with three MCP tools from different vendors. Tool A returns dates as Unix timestamps, Tool B returns ISO 8601 strings, and Tool C returns dates as "DD/MM/YYYY". The agent frequently miscomputes date differences when comparing results across tools. What is the cleanest architectural fix?

  **(A)** Add a date normalization instruction to the system prompt telling the agent to convert all formats
  **(B)** Add few-shot examples showing correct date parsing for each tool's format
✔ **(C)** Implement a PostToolUse hook that normalizes all date fields to one format
  **(D)** Wrap each MCP tool call in a helper function that normalizes the response
...
Refs: [Agent SDK hooks](https://platform.claude.com/docs/en/agent-sdk/hooks)

## Q116 · D1 Agentic Architecture & Orchestration · [advanced]
...
Refs: [Task decomposition strategies](https://docs.anthropic.com/en/docs/build-with-claude/agentic-systems/orchestration)

## Q117 · D1 Agentic Architecture & Orchestration · [intermediate]
...
Refs: [Session management](https://docs.anthropic.com/en/docs/claude-code/session-management)

## Q118 · D1 Agentic Architecture & Orchestration · [advanced]
...
Refs: [Session resumption patterns](https://docs.anthropic.com/en/docs/claude-code/session-management)

## Q119 · D2 Tool Design & MCP Integration · [basic]
...
## Q120 · D2 Tool Design & MCP Integration · [intermediate]
...
## Q121 · D2 Tool Design & MCP Integration · [basic]
...
Refs: [Built-in tools reference](https://docs.anthropic.com/en/docs/claude-code/built-in-tools)

## Q122 · D2 Tool Design & MCP Integration · [intermediate]
...
## Q123 · D3 Claude Code Configuration & Workflows · [basic]
...
Refs: [CLAUDE.md configuration hierarchy](https://docs.anthropic.com/en/docs/claude-code/memory)

## Q124 · D3 Claude Code Configuration & Workflows · [intermediate]
...
## Q125 · D3 Claude Code Configuration & Workflows · [intermediate]
...
Refs: [Claude Code skills](https://docs.anthropic.com/en/docs/claude-code/skills)

## Q126 · D3 Claude Code Configuration & Workflows · [basic]
...
## Q127 · D3 Claude Code Configuration & Workflows · [intermediate]
...
Refs: [Iterative refinement](https://docs.anthropic.com/en/docs/claude-code/best-practices)

## Q128 · D4 Prompt Engineering & Structured Output · [basic]
...
## Q129 · D4 Prompt Engineering & Structured Output · [intermediate]
...
## Q130 · D4 Prompt Engineering & Structured Output · [intermediate]
...
Refs: [Structured output with tool use](https://docs.anthropic.com/en/docs/build-with-claude/tool-use)

## Q131 · D4 Prompt Engineering & Structured Output · [intermediate]
...
Refs: [Validation and retry patterns](https://docs.anthropic.com/en/docs/build-with-claude/tool-use)

## Q132 · D4 Prompt Engineering & Structured Output · [advanced]
...
## Q133 · D4 Prompt Engineering & Structured Output · [intermediate]
...
## Q134 · D5 Context Management & Reliability · [intermediate]
...
Refs: [Context management patterns](https://docs.anthropic.com/en/docs/build-with-claude/context-windows)

## Q135 · D5 Context Management & Reliability · [advanced]
...
## Q136 · D5 Context Management & Reliability · [intermediate]
...
Refs: [Escalation patterns](https://docs.anthropic.com/en/docs/build-with-claude/agentic-systems/human-in-the-loop)

## Q137 · D5 Context Management & Reliability · [basic]
...
## Q138 · D5 Context Management & Reliability · [intermediate]
...
Refs: [Context management in long sessions](https://docs.anthropic.com/en/docs/build-with-claude/context-windows)

## Q139 · D5 Context Management & Reliability · [advanced]
...
Refs: [Human review and confidence calibration](https://docs.anthropic.com/en/docs/build-with-claude/agentic-systems/human-in-the-loop)

## Q140 · D5 Context Management & Reliability · [advanced]
...
Refs: [Information provenance and synthesis](https://docs.anthropic.com/en/docs/build-with-claude/agentic-systems/orchestration)

## Q141 · D1 Agentic Architecture & Orchestration · [advanced]
...
## Q142 · D1 Agentic Architecture & Orchestration · [advanced]
...
Refs: [Subagents and context isolation](https://docs.anthropic.com/en/docs/build-with-claude/agentic-systems/orchestration) · [Agent SDK — Task tool](https://docs.anthropic.com/en/docs/agent-sdk/task-tool)

## Q143 · D2 Tool Design & MCP Integration · [basic]
...
## Q144 · D2 Tool Design & MCP Integration · [intermediate]
...
## Q145 · D2 Tool Design & MCP Integration · [intermediate]
...
Refs: [Tool descriptions and selection](https://docs.anthropic.com/en/docs/build-with-claude/tool-use/tool-use-best-practices)

## Q146 · D3 Claude Code Configuration & Workflows · [basic]
...
## Q147 · D3 Claude Code Configuration & Workflows · [intermediate]
...
Refs: [Claude Code CLI reference](https://docs.anthropic.com/en/docs/claude-code/cli-reference) · [Claude Code CI/CD integration](https://docs.anthropic.com/en/docs/claude-code/github-actions)

## Q148 · D3 Claude Code Configuration & Workflows · [advanced]
...
Refs: [Claude Code CI/CD integration](https://docs.anthropic.com/en/docs/claude-code/github-actions)

## Q149 · D3 Claude Code Configuration & Workflows · [intermediate]
...
Refs: [Claude Code iterative development](https://docs.anthropic.com/en/docs/claude-code/best-practices)

## Q150 · D3 Claude Code Configuration & Workflows · [intermediate]
...
Refs: [Claude Code context management](https://docs.anthropic.com/en/docs/claude-code/best-practices)

## Q151 · D3 Claude Code Configuration & Workflows · [intermediate]
...
Refs: [Claude Code best practices](https://docs.anthropic.com/en/docs/claude-code/best-practices)

## Q152 · D4 Prompt Engineering & Structured Output · [intermediate]
...
Refs: [Structured output schema design](https://docs.anthropic.com/en/docs/build-with-claude/structured-outputs)

## Q153 · D4 Prompt Engineering & Structured Output · [advanced]
...
Refs: [Structured output for analysis pipelines](https://docs.anthropic.com/en/docs/build-with-claude/structured-outputs)

## Q154 · D4 Prompt Engineering & Structured Output · [advanced]
...
Refs: [Message Batches API](https://docs.anthropic.com/en/docs/build-with-claude/message-batches)

## Q155 · D4 Prompt Engineering & Structured Output · [advanced]
...
Refs: [Human review and confidence calibration](https://docs.anthropic.com/en/docs/build-with-claude/agentic-systems/human-in-the-loop) · [Structured output patterns](https://docs.anthropic.com/en/docs/build-with-claude/structured-outputs)

## Q156 · D5 Context Management & Reliability · [intermediate]
...
Refs: [Agentic systems — human in the loop](https://docs.anthropic.com/en/docs/build-with-claude/agentic-systems/human-in-the-loop)

## Q157 · D5 Context Management & Reliability · [intermediate]
...
Refs: [Escalation and handoff patterns](https://docs.anthropic.com/en/docs/build-with-claude/agentic-systems/human-in-the-loop)

## Q158 · D5 Context Management & Reliability · [advanced]
...
Refs: [Multi-agent synthesis patterns](https://docs.anthropic.com/en/docs/build-with-claude/agentic-systems/orchestration) · [Structured output design](https://docs.anthropic.com/en/docs/build-with-claude/structured-outputs)

## Q159 · D4 Prompt Engineering & Structured Output · [exam]
...
## Q160 · D4 Prompt Engineering & Structured Output · [exam]
...
## Q161 · D4 Prompt Engineering & Structured Output · [exam]
...
## Q162 · D4 Prompt Engineering & Structured Output · [exam]
*Scenario: Your team uses the Claude Code CLI with --print mode for automated PR reviews in CI. The review pipeline analyzes code quality, documentation accuracy, and potential bugs across a large codebase with varied commenting conventions.*
...
## Q163 · D3 Claude Code Configuration & Workflows · [exam]
*Scenario: You are using Claude Code to accelerate software development. Your team uses it for code generation, refactoring, debugging, and documentation. You need to integrate it into your development workflow with custom slash commands, CLAUDE.md configurations, and understand when to use plan mode vs direct execution.*
...
## Q164 · D3 Claude Code Configuration & Workflows · [basic]
...
## Q165 · D5 Context Management & Reliability · [exam]
...
> _Why A is wrong:_ Asking customers "Does this fully address your concern?" puts the burden on the customer to identify gaps in the agent's explanation — a poor experience. Many customers will not know what policy details or next steps they are missing until they need them later.
> _Why B is wrong:_ Few-shot examples for five common case types provide templates but cannot cover all complex case variations. The root cause is variable, case-specific gaps; a fixed set of templates cannot catch gaps in novel case configurations.
> _Why C is wrong:_ A model tier upgrade may improve general quality but provides no targeted mechanism to detect or fill completeness gaps in the response. Without a self-critique step, a more capable model will still produce inconsistently complete explanations.

Refs: [Agentic systems — human in the loop](https://docs.anthropic.com/en/docs/build-with-claude/agentic-systems/human-in-the-loop) · [Build effective agents](https://docs.anthropic.com/en/docs/build-with-claude/agentic-systems/build-effective-agents)

## Q166 · D1 Agentic Architecture & Orchestration · [exam]
...
## Q167 · D5 Context Management & Reliability · [exam]
*Scenario: Your team built a multi-agent research system using Claude as a coordinator with specialized subagents: a web search agent, a document analysis agent, and a synthesis agent. The coordinator decomposes research topics, delegates to subagents, and passes combined findings to the synthesis agent.*
...
> Graceful degradation with transparency is the correct pattern: the synthesis agent produces the most useful output possible from available data, while explicitly annotating which findings are well-supported and which areas have gaps due to unavailable sources. This preserves the value of the completed work (3 of 5 sources succeeded) and propagates uncertainty information so downstream consumers can make informed decisions. Blocking on retry (A) delays the entire output for sources that may time out again. Returning an error (C) discards all completed work. Silent synthesis (D) hides the uncertainty, potentially leading consumers to make decisions on incomplete data without knowing it.

> _Why A is wrong:_ Blocking synthesis until all sources respond discards the value of the 3 successful sources and the completed document analysis while waiting for timed-out sources that may never respond. A partial synthesis with gap annotations is more useful than no synthesis.
> _Why B is wrong:_ Returning an error and discarding all completed work means the successfully retrieved competitor websites, industry reports, and all analyzed documents produce nothing. This is the worst outcome — it wastes all completed work for the sake of two failed sources.
> _Why C is wrong:_ Synthesizing silently without gap annotations produces output that appears comprehensive but is not. Consumers may make decisions based on missing news and social media perspectives without knowing those sources failed, which is worse than knowing the gaps exist.

Refs: [Build effective agents — error handling](https://docs.anthropic.com/en/docs/build-with-claude/agentic-systems/build-effective-agents) · [Context management](https://docs.anthropic.com/en/docs/build-with-claude/context-windows)

## Q168 · D5 Context Management & Reliability · [exam]
*Scenario: Your team built a multi-agent research system using Claude as a coordinator with specialized subagents: a web search agent, a document analysis agent, and a synthesis agent. The coordinator decomposes research topics, delegates to subagents, and passes combined findings to the synthesis agent.*
...
> _Why A is wrong:_ Rotation ensures each source receives primacy positioning equally across tasks, but this does not improve synthesis quality for any individual task — critical findings from one source will still be in the middle when the other source leads. The problem recurs for every task.
> _Why B is wrong:_ Streaming web results first to completion before introducing document analysis results converts parallel aggregation into sequential processing. This eliminates the performance benefit of running subagents in parallel and does not address the attention distribution problem for whichever source comes second.
> _Why C is wrong:_ Summarizing all outputs to 20K tokens reduces the lost-in-the-middle risk by shrinking the context, but aggressive compression risks losing important secondary findings. A key findings summary at the start plus section headers achieves the attention improvement without discarding content.

Refs: [Context windows and attention](https://docs.anthropic.com/en/docs/build-with-claude/context-windows) · [Build effective agents](https://docs.anthropic.com/en/docs/build-with-claude/agentic-systems/build-effective-agents)

## Q169 · D1 Agentic Architecture & Orchestration · [exam]
*Scenario: Your team built a multi-agent research system using Claude as a coordinator with specialized subagents: a web search agent, a document analysis agent, and a synthesis agent. The coordinator decomposes research topics, delegates to subagents, and passes combined findings to the synthesis agent.*
...
## Q170 · D2 Tool Design & MCP Integration · [exam]
*Scenario: Your team is building an AI-powered customer support agent that handles order inquiries, billing disputes, and account management. The agent uses a set of tools including get_customer, lookup_order, process_refund, and escalate_to_human to resolve customer issues autonomously.*
