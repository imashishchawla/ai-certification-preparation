---
title: "Code Claude Com Docs En Agent Sdk Sessions"
meta: "Official Anthropic docs"
tags: ["study", "official-docs"]
---

<!-- source: https://code.claude.com/docs/en/agent-sdk/sessions (fetched https://code.claude.com/docs/en/agent-sdk/sessions.md) -->
