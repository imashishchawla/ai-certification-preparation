---
title: "Platform Claude Com Docs En Agents And Tools Tool Use Overview"
meta: "Official Anthropic docs"
tags: ["study", "official-docs"]
---

<!-- source: https://platform.claude.com/docs/en/agents-and-tools/tool-use/overview (fetched https://docs.anthropic.com/en/agents-and-tools/tool-use/overview.md) -->
